...
class VoyagerBaseController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $kategoribidang = KategoriBidang::get();
        $kategorisubbidang = KategoriSubBidang::where('kategori_bidang_id', $dataTypeContent->kategori_bidang_id)->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','kategoribidang','kategorisubbidang'));
    }
