                            ...
                            <tbody>
                                ...
                                @foreach ($agenda as $valueagenda)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $valueagenda->location }}</td>
                                        <td class="text-center">{{ $valueagenda->dihadiri }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-light" width="100%">
                            <thead class="thead-dark">
                                <tr class="text-center">
                                    <th width="2%">No</th>
                                    <th>Nama Pejabat/Jabatan</th>
                                    <th width="40%">Status Kehadiran</th>
                                    {{-- Hadir/Tidak Hadir/Tidak Ada Keterangan --}}
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($pejabat as $valuepejabat)
                                    <tr>
                                        <th class="text-center">{{ $loop->iteration }}</th>
                                        <td>{{ $valuepejabat->nama }} / {{ $valuepejabat->jabatan }}
                                        </td>
                                        <td class="text-center"><b>{{ $valuepejabat->status_kehadiran }}</b></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
