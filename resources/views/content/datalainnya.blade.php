        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    @foreach (App\Models\CategoryDataCenter::orderBy('order','desc')->get() as $k=>$c)
                        ...
                        <div id="collapse{{$c->id}}" class="panel-collapse collapse @if($k == 0) in @endif" role="tabpanel" aria-labelledby="heading{{$c->id}}">
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach (App\Models\DataCenter::where('category_data_center_id',$c->id)->orderBy('order','desc')->get() as $d)
                                        <tr>
