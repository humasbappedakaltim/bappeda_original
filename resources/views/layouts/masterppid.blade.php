...
<link href="{{asset('')}}fullcalendar/main.css" rel="stylesheet">
    ...
    <body class="demo-5">
        ...
        <div class="wrapper"> 
				...
				<div class="city_top_wrap">
					<div class="container">
						<div class="city_top_logo">
							<figure>
								<h1><a href="{{url('/')}}"><img src="{{asset('storage/settings/November2020/logo ppid1.3.png')}}" alt="TopLogo"></a></h1>
							</figure>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="navigation">
									<ul>
										{{menu('ppid_menu','layouts.nav-item')}}
									</ul>									
								</div>
								<!--DL Menu Start-->
								<div id="kode-responsive-navigation" class="dl-menuwrapper">
									...
									<ul class="dl-menu">
										{{menu('ppid_menu','layouts.nav-item2')}}
									</ul>
								</div>
								<!--DL Menu END-->
							</div>
			...
			<footer>
				<div class="widget_wrap overlay" style="padding: 50px 0px 0px;!important">
					<div class="container">
						<div class="row">
							...
							<div class="widget_copyright row">
								<div class="col-md-3 col-sm-6">
									<div class="widget_logo">
										<a href="#"><img src="{{asset('')}}theme/main/images/top-logo-bappeda.png" alt=""></a>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="copyright_text">
										<p><span>Copyright © 2021 - All Rights Reserved {{config('app.name')}}</span> </p>
									</div>
								</div>
            ...
            <a href="https://bappeda.kaltimprov.go.id" style="position: fixed; right: 10px; bottom: 15px; z-index: 3;"><button type="button" class="btn btn-primary" style="color: #fff; padding: 10px; height: 50px; background-color: #34495e;">Kembali ke Portal</button></a>
		</div>
		 <!--WRAPPER END-->
        <!--Jquery Library-->
